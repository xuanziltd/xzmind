...
;(function(factory) {
    ...
    editormd.toolbarModes = {
        ...
        phone : [
            ...
            "bold", "del", "italic", "quote", "uppercase", "lowercase", "|", 
            "h1", "h2", "h3", "h4", "|", 
            "list-ul", "list-ol", "hr","link", "image",  "code","|",
            "watch", "preview"
        ],
        mini : [
            "undo", "redo", "|",
    ...
    editormd.prototype    = editormd.fn = {
        ...
        init : function (id, options) {
            ...
            this.supermind = settings.supermind;
        ...
        katexRender : function() {
          ...
          //  console.log('render mind '+editormd.classNames.tex);
            if (timer === null)
            {
                return this;
            }
